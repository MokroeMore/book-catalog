...
import {BookSearchBarComponent} from '@app/books/components/book-search-bar/book-search-bar';
...
@Component({
  ...
  imports: [CommonModule, BookSearchBarComponent, BooksListComponent, RouterModule],
